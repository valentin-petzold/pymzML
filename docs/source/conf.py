...
# -*- coding: utf-8 -*-
#
# pymzML documentation build configuration file, created by
# sphinx-quickstart on Fri Nov  4 08:36:43 2016.
#
...
example_scripts_path = os.path.join(
    os.path.dirname(__file__),
    os.pardir,
    os.pardir,
    'example_scripts',
...
sys.path.insert(0, os.path.abspath(example_scripts_path))
...
latex_documents = [
  (master_doc, 'pymzML.tex', 'pymzML Documentation',
   'Koesters, M. and Fufezan, C.', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymzml', 'pymzML Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pymzML', 'pymzML Documentation',
   author, 'pymzML', 'One line description of project.',
   'Miscellaneous'),
]
